...
const SCRIPT: Line[] = [
  ...
  { type: "success", text: "✓  Antigravity   healthy   priority 0",         delay: 90 },
  { type: "success", text: "✓  Cerebras      healthy   priority 1",         delay: 90 },
  { type: "success", text: "✓  Groq          healthy   priority 2",         delay: 90 },
  { type: "success", text: "✓  Claude        healthy   priority 3",         delay: 90 },
  { type: "success", text: "✓  Hermes        healthy   priority 3",         delay: 90 },
  { type: "success", text: "✓  Mistral       healthy   priority 3",         delay: 90 },
  { type: "success", text: "✓  Codex         healthy   priority 4",         delay: 90 },
  { type: "success", text: "✓  OpenAI Image  healthy   priority 4",         delay: 90 },
  { type: "success", text: "✓  Copilot       healthy   priority 5",         delay: 90 },
  { type: "success", text: "✓  OpenRouter    healthy   priority 5",         delay: 90 },
  { type: "success", text: "✓  OpenAI        healthy   priority 6",         delay: 90 },
  { type: "success", text: "✓  Ollama        healthy   priority 7",         delay: 90 },
  { type: "blank",   text: "",                                               delay: 300 },
  { type: "cmd",     text: "$ forge projects --active",                     delay: 500 },
  { type: "output",  text: "NAME              ROLE          STATUS",         delay: 100 },
  { type: "success", text: "forge-router      flagship      v0.5.1 · 12 providers · Gateway MVP", delay: 100 },
  { type: "success", text: "AI FORGE          featured      enterprise agent OS · Bedrock",       delay: 100 },
  { type: "success", text: "forge-SRE         production    SRE governance · 19 clusters",        delay: 100 },
  { type: "success", text: "Saturs            freelance     AWS cost optimization · -86.5%",      delay: 100 },
  { type: "success", text: "AI-ForgeStream    production    K8s-native media pipeline",            delay: 100 },
  { type: "blank",   text: "",                                               delay: 300 },
  { type: "cmd",     text: "$ code forge-router",                           delay: 500 },
  { type: "output",  text: "Opening forge-router — Flagship Project — in editor...",  delay: 300 },
  { type: "success", text: "✓  governance-compatible Gateway · virtual keys · metering", delay: 200 },
  { type: "blank",   text: "",                                               delay: 300 },
